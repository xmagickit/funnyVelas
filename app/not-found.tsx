...
export const metadata: Metadata = {
  ...
  description: "You can't find this page.",
  // other metadata
};
    ...
    <>
      <div className="rounded-sm border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
        <div className="mx-auto max-w-[410px]">
          <Image src="/images/illustration-01-1d37a785.svg" alt="illustration" width={400} height={400} />
