              ...
              <div>
                ...
                <ul>
                  <li>
                    <Link
                      href="/policy"
                      className="dark:text-body-color-dark mb-2 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                    >
                      Policy
                    </Link>
                  </li>
