                ...
                <div className="modal-body p-6">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex justify-end">
                            <button
                                type="button"
                                className="rounded-lg  text-base md:text-lg px-7 py-3 w-[160px] md:w-[200px] focus:outline-0 leading-6 text-center disabled:cursor-not-allowed disabled:opacity-50"
                                onClick={closeModal}
                            >
                                Cancel
                            </button>
